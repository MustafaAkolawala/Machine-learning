...
def train_model():
    try:
        ...
        # Correct the keyword argument from base_estimator to estimator
...
window = tk.Tk()
window.title("Bagging Classifier GUI by Sudheendra 211P048")
...
# Frame to hold the canvas for the confusion matrix
