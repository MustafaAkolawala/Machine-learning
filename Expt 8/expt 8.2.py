...
master = Tk()
master.title("Sudheendra => 211P048 Customer Segmentation using Machine Learning")
Label(master, text="Sudheendra => 211P048 Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
